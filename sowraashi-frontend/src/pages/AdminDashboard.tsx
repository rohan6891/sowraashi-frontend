...
import { Upload, X, Edit, Trash2, Eye, Settings as SettingsIcon, LogOut } from 'lucide-react';
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="bg-gray-600 text-white px-4 py-2 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-400 flex items-center space-x-2"
                  title="Settings"
                >
                ...
                <button
                  ...
                  className="bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-red-400 flex items-center space-x-2"
                  title="Logout"
                >
